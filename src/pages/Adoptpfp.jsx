...
const Adoptpfp = () => {
  ...
  return <p className="text-center mt-10 text-red-500">Pet not found!</p>;
    ...
    return (
      <div className="border-white text-white font-bold bg-amber-300 flex flex-col lg:flex-row gap-10 p-5">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          required
          className="border border-white-500 text-white-500 p-2 rounded placeholder:text-white"
          />
          <input 
          name="email"
          type="email"
